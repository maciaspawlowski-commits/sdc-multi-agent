"""OpenTelemetry setup — exports to Dash0 (OTLP) or console when no endpoint is set."""
...
def setup_telemetry(app=None) -> None:
    ...
    if endpoint:
        ...
        logger.info("Tracing → console (set OTEL_EXPORTER_OTLP_ENDPOINT + DASH0_AUTH_TOKEN for Dash0)")
